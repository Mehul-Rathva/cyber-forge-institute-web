      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-cyan-500 to-blue-500 transform md:-translate-x-1/2"></div>
            ...
            {milestones.map((milestone, index) => {
              ...
              return (
                ...
                >
                  {/* Timeline Dot */}
                  <div className={`absolute left-8 md:left-1/2 w-4 h-4 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full transform md:-translate-x-1/2 z-10 transition-all duration-500 ${
